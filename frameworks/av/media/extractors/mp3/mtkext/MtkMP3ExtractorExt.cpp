...
int MtkMP3SourceExt::getMultiFrameSize(DataSourceBase *source, off64_t pos,
    ...
    uint32_t fixedHeader)
{
    if(source->flags() & DataSourceBase::kIsCachingDataSource){//streaming using
        ...
        if (durationUsStream >= 0) {
            meta->setInt64(kKeyDuration, durationUsStream);
        }
...
////////////////////////////////////////////////////////////////////////////////
MtkMP3Toc::MtkMP3Toc(DataSourceBase *source, uint32_t fixedHeader)
    :mDataSource(source),
