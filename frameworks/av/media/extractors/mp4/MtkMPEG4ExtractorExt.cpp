...
//#include "include/media/stagefright/foundation/avc_utils.h"
#include <media/stagefright/foundation/avc_utils.h>
#include <media/stagefright/foundation/ByteUtils.h>
#include <media/stagefright/MediaBufferBase.h>
//#include <media/stagefright/MetaDataBase_MTK.h>
...
status_t MPEG4Extractor::parseRawSampleEntry(DataSourceBase *source,
...
status_t MPEG4Extractor::parseALACSampleEntry(DataSourceBase *source,
...
sp<ABuffer> MPEG4Extractor::MakeESDS(const sp<ABuffer> &csd) {
      ALOGD("MakeESDS");
...
void MPEG4Extractor::EncodeSize14_1(uint8_t **_ptr, size_t size) {
      ALOGD("EncodeSize14_1");
