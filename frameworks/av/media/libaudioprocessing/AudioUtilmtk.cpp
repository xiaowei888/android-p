...
const char * const AudioDump::af_track_pcm = "/sdcard/mtklog/audio_dump/af_track_pcm";
const char * const AudioDump::af_mixer_pcm = "/sdcard/mtklog/audio_dump/af_mixer_pcm.pcm";
const char * const AudioDump::af_mixer_write_pcm = "/sdcard/mtklog/audio_dump/af_mixer_write_pcm.pcm";
const char * const AudioDump::af_mixer_end_pcm = "/sdcard/mtklog/audio_dump/mixer_end";
const char * const AudioDump::af_offload_write_raw = "/sdcard/mtklog/audio_dump/af_offload_write_pcm.raw";
const char * const AudioDump::af_record_pcm = "/sdcard/mtklog/audio_dump/af_record.pcm";
const char * const AudioDump::af_effect_pcm = "/sdcard/mtklog/audio_dump/af_effect.pcm";
const char * const AudioDump::af_mixer_drc_pcm_before = "/sdcard/mtklog/audio_dump/mixer_drc_before";
const char * const AudioDump::af_mixer_drc_pcm_after = "/sdcard/mtklog/audio_dump/mixer_drc_after";
const char * const AudioDump::af_resampler_in_pcm = "/sdcard/mtklog/audio_dump/af_mixer_resampler_in.pcm";
const char * const AudioDump::af_resampler_out_pcm = "/sdcard/mtklog/audio_dump/af_mixer_resampler_out.pcm";
