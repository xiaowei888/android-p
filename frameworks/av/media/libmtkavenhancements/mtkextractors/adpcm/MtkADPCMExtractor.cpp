...
struct MtkADPCMSource : public MediaTrack {
    MtkADPCMSource(
...
MtkADPCMExtractor::MtkADPCMExtractor(DataSourceBase *source)
    : mDataSource(source),
      mValidFormat(false),
...
status_t MtkADPCMExtractor::getMetaData(MetaDataBase &meta) {
    meta.clear();
    if (mInitCheck == OK) {
...
MediaTrack *MtkADPCMExtractor::getTrack(size_t index) {
...
status_t MtkADPCMExtractor::getTrackMetaData(
        MetaDataBase &meta,
...
status_t MtkADPCMSource::start(MetaDataBase * /* params */) {
...
status_t MtkADPCMSource::getFormat(MetaDataBase &meta) {
...
static MediaExtractor::CreatorFunc Sniff(
    ...
    MediaExtractor *extractor = new MtkADPCMExtractor(source);
