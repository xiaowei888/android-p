...
class AudioPolicyManagerCustomInterface
{
    public:
        ...
        virtual bool lowLatency_setOutputFirstActiveFromStartSource(const sp<AudioOutputDescriptor>& outputDesc, bool beFirstActive, audio_devices_t device) = 0;
        ...
        virtual status_t hifiAudio_startOutputSamplerate(audio_io_handle_t output, audio_stream_type_t stream, audio_session_t session, int samplerate) = 0;
        virtual status_t hifiAudio_stopOutputSamplerate(audio_io_handle_t output, audio_stream_type_t stream, audio_session_t session, int samplerate) = 0;
