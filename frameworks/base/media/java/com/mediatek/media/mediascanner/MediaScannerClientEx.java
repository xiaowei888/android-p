...
public class MediaScannerClientEx {
    public void init() {
    ...
    public boolean doesSettingEmpty(String settingName, final Context context) {
        return false;
    }

    public void setSettingFlag(String settingName, final Context context) {
    }

    public boolean isValueslessMimeType(String mimetype) {
        return false;
    }
}
