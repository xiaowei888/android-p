...
int ANeuralNetworksModel_create(ANeuralNetworksModel** model) {
    ...
    if (ANeuroPilotModelPrivate_makeModelBuilder(model, &ret)) {
        LOG(DEBUG) << "ANeuralNetworksModel_create MTK model: %d", ret;
        return ret;
    }
    /// @}
...
int ANeuralNetworksCompilation_create(ANeuralNetworksModel* model,
    ...
    /// M: NeuroPilot @{
    int ret = ANEURALNETWORKS_NO_ERROR;
    if (ANeuroPilotCompilationPrivate_makeCompilationBuilder(model, compilation, &ret)) {
        LOG(DEBUG) << "ANeuralNetworksCompilation_create MTK compilation: %d", ret;
        return ret;
    }
    /// @}
...
int ANeuralNetworksExecution_create(ANeuralNetworksCompilation* compilation,
    ...
    /// M: NeuroPilot @{
    int ret = ANEURALNETWORKS_NO_ERROR;
    if (ANeuroPilotExecutionPrivate_makeExecutionBuilder(compilation, execution, &ret)) {
        LOG(DEBUG) << "ANeuralNetworksExecution_create MTK execution: %d", ret;
        return ret;
    }
    /// @}
