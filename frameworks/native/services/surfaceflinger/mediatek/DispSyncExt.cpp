...
bool DispSync::addEventListenerEnhancement(status_t* res, const char* name, nsecs_t phase, Callback* callback) {
    if (mEnhancement) {
...
bool DispSync::removeEventListenerEnhancement(status_t* res, Callback* callback) {
    if (mEnhancement) {
